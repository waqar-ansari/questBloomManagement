...
export default function About() {
  return (
    <>
      ...
      <div className="text-with-img-2 mb_90 pb_90">
        <div className="tf-container">
          <div className="row">
            <div className="col-lg-6">
              <div className="wrap-img">
...
Mr.Tianlai Zhang (Simon) holds dual membership with two prestigious accounting institutions, chartered accountant (ACA) with ICAEW, also a fellow member of ACCA (FCCA). With over 20 years experience in both practice and corporate.
He specialised in dealing with corporate and tax matters in the UK and UAE region, predominantly in property, financial services and high-tech business, industries from the private equity firm to the large public listed investment research house, from AI driven quants trading business to Crypto exchanges. His rich experiences and expertise allow him to design customer tailored solutions effectively and execute quickly in the wide network he connects with.
He helped many clients for both corporate and High Net Worth (HNW) individuals, served them with cost effective cross border tax planning solutions. And he leads a well experienced team, who can look after our clients' ongoing accounting and tax compliance matters with the UK and UAE authorities.  
